Namespace ScottPlot.Drawing.Colormaps
    ...
    Public Class Tarn
        ...
        Public Function GetRGB(value As Byte) As Tuple(Of Byte, Byte, Byte) Implements ScottPlot.Drawing.IColormap.GetRGB
            Return New Tuple(Of Byte, Byte, Byte)(Tarn.CmapLocal(value, 0), Tarn.CmapLocal(value, 1), Tarn.CmapLocal(value, 2))
        End Function

        Public ReadOnly Property Name As String = "Tarn" Implements ScottPlot.Drawing.IColormap.Name
