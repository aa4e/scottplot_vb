Namespace ScottPlot.Drawing.Colormaps
    ...
    Public Class Matter
        ...
        Public Function GetRGB(value As Byte) As Tuple(Of Byte, Byte, Byte) Implements ScottPlot.Drawing.IColormap.GetRGB
            Return New Tuple(Of Byte, Byte, Byte)(Matter.CmapLocal(value, 0), Matter.CmapLocal(value, 1), Matter.CmapLocal(value, 2))
        End Function

        Public ReadOnly Property Name As String = "Matter" Implements ScottPlot.Drawing.IColormap.Name
