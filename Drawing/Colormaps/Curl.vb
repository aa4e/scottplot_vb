Namespace ScottPlot.Drawing.Colormaps
    ...
    Public Class Curl
        ...
        Public Function GetRGB(value As Byte) As Tuple(Of Byte, Byte, Byte) Implements ScottPlot.Drawing.IColormap.GetRGB
            Return New Tuple(Of Byte, Byte, Byte)(Curl.Cmaplocal(value, 0), Curl.Cmaplocal(value, 1), Curl.Cmaplocal(value, 2))
        End Function

        Public ReadOnly Property Name As String = "Curl" Implements ScottPlot.Drawing.IColormap.Name
