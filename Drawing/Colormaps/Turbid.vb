Namespace ScottPlot.Drawing.Colormaps
    ...
    Public Class Turbid
        ...
        Public Function GetRGB(value As Byte) As Tuple(Of Byte, Byte, Byte) Implements ScottPlot.Drawing.IColormap.GetRGB
            Return New Tuple(Of Byte, Byte, Byte)(Turbid.CmapLocal(value, 0), Turbid.CmapLocal(value, 1), Turbid.CmapLocal(value, 2))
        End Function

        Public ReadOnly Property Name As String = "Turbid" Implements ScottPlot.Drawing.IColormap.Name
