Namespace ScottPlot.Drawing.Colormaps
    ...
    ''' </summary>
    ''' <remarks>
    ''' All credit to Kristen Thyng. This colormap is under the MIT License.
    ...
    Public Class Algae
        ...
        Public Function GetRGB(value As Byte) As Tuple(Of Byte, Byte, Byte) Implements ScottPlot.Drawing.IColormap.GetRGB
            Return New Tuple(Of Byte, Byte, Byte)(Algae.CmapLocal(value, 0), Algae.CmapLocal(value, 1), Algae.CmapLocal(value, 2))
        End Function

        Public ReadOnly Property Name As String = "Algae" Implements ScottPlot.Drawing.IColormap.Name
