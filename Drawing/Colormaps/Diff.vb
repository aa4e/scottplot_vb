Namespace ScottPlot.Drawing.Colormaps
    ...
    Public Class Diff
        ...
        Public Function GetRGB(value As Byte) As Tuple(Of Byte, Byte, Byte) Implements ScottPlot.Drawing.IColormap.GetRGB
            Return New Tuple(Of Byte, Byte, Byte)(Diff.Cmaplocal(value, 0), Diff.Cmaplocal(value, 1), Diff.Cmaplocal(value, 2))
        End Function

        Public ReadOnly Property Name As String = "Diff" Implements ScottPlot.Drawing.IColormap.Name
