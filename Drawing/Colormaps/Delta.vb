Namespace ScottPlot.Drawing.Colormaps
    ...
    Public Class Delta
        ...
        Public Function GetRGB(value As Byte) As Tuple(Of Byte, Byte, Byte) Implements ScottPlot.Drawing.IColormap.GetRGB
            Return New Tuple(Of Byte, Byte, Byte)(Delta.Cmaplocal(value, 0), Delta.Cmaplocal(value, 1), Delta.Cmaplocal(value, 2))
        End Function

        Public ReadOnly Property Name As String = "Delta" Implements ScottPlot.Drawing.IColormap.Name
