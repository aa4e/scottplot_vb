Namespace ScottPlot.Drawing.Colormaps
    ...
    Public Class Speed
        ...
        Public Function GetRGB(value As Byte) As Tuple(Of Byte, Byte, Byte) Implements ScottPlot.Drawing.IColormap.GetRGB
            Return New Tuple(Of Byte, Byte, Byte)(Speed.CmapLocal(value, 0), Speed.CmapLocal(value, 1), Speed.CmapLocal(value, 2))
        End Function

        Public ReadOnly Property Name As String = "Speed" Implements ScottPlot.Drawing.IColormap.Name
