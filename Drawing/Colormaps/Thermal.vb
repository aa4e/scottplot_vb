Namespace ScottPlot.Drawing.Colormaps
    ...
    Public Class Thermal
        ...
        Public Function GetRGB(value As Byte) As Tuple(Of Byte, Byte, Byte) Implements ScottPlot.Drawing.IColormap.GetRGB
            Return New Tuple(Of Byte, Byte, Byte)(Thermal.CmapLocal(value, 0), Thermal.CmapLocal(value, 1), Thermal.CmapLocal(value, 2))
        End Function

        Public ReadOnly Property Name As String = "Thermal" Implements ScottPlot.Drawing.IColormap.Name
