Namespace ScottPlot.Drawing.Colormaps
    ...
    Public Class Tempo
        ...
        Public Function GetRGB(value As Byte) As Tuple(Of Byte, Byte, Byte) Implements ScottPlot.Drawing.IColormap.GetRGB
            Return New Tuple(Of Byte, Byte, Byte)(Tempo.CmapLocal(value, 0), Tempo.CmapLocal(value, 1), Tempo.CmapLocal(value, 2))
        End Function

        Public ReadOnly Property Name As String = "Tempo" Implements ScottPlot.Drawing.IColormap.Name
