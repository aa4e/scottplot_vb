Namespace ScottPlot.Drawing.Colormaps
    ...
    Public Class Topo
        ...
        Public Function GetRGB(value As Byte) As Tuple(Of Byte, Byte, Byte) Implements ScottPlot.Drawing.IColormap.GetRGB
            Return New Tuple(Of Byte, Byte, Byte)(Topo.CmapLocal(value, 0), Topo.CmapLocal(value, 1), Topo.CmapLocal(value, 2))
        End Function

        Public ReadOnly Property Name As String = "Topo" Implements ScottPlot.Drawing.IColormap.Name
