Namespace ScottPlot.Drawing.Colormaps
    ...
    Public Class Balance
        ...
        Public Function GetRGB(value As Byte) As Tuple(Of Byte, Byte, Byte) Implements ScottPlot.Drawing.IColormap.GetRGB
            Return New Tuple(Of Byte, Byte, Byte)(Balance.CmapLocal(value, 0), Balance.CmapLocal(value, 1), Balance.CmapLocal(value, 2))
        End Function

        Public ReadOnly Property Name As String = "Balance" Implements ScottPlot.Drawing.IColormap.Name
