Namespace ScottPlot.Drawing.Colormaps
    ...
    Public Class Ice
        ...
        Public Function GetRGB(value As Byte) As Tuple(Of Byte, Byte, Byte) Implements ScottPlot.Drawing.IColormap.GetRGB
            Return New Tuple(Of Byte, Byte, Byte)(Ice.CmapLocal(value, 0), Ice.CmapLocal(value, 1), Ice.CmapLocal(value, 2))
        End Function

        Public ReadOnly Property Name As String = "Ice" Implements ScottPlot.Drawing.IColormap.Name
