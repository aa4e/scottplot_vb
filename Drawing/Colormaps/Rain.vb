Namespace ScottPlot.Drawing.Colormaps
    ...
    Public Class Rain
        ...
        Public Function GetRGB(value As Byte) As Tuple(Of Byte, Byte, Byte) Implements ScottPlot.Drawing.IColormap.GetRGB
            Return New Tuple(Of Byte, Byte, Byte)(Rain.CmapLocal(value, 0), Rain.CmapLocal(value, 1), Rain.CmapLocal(value, 2))
        End Function

        Public ReadOnly Property Name As String = "Rain" Implements ScottPlot.Drawing.IColormap.Name
