Namespace ScottPlot.Drawing.Colormaps
    ...
    Public Class Deep
        ...
        Public Function GetRGB(value As Byte) As Tuple(Of Byte, Byte, Byte) Implements ScottPlot.Drawing.IColormap.GetRGB
            Return New Tuple(Of Byte, Byte, Byte)(Deep.Cmaplocal(value, 0), Deep.Cmaplocal(value, 1), Deep.Cmaplocal(value, 2))
        End Function

        Public ReadOnly Property Name As String = "Deep" Implements ScottPlot.Drawing.IColormap.Name
