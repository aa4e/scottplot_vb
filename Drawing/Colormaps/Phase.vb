Namespace ScottPlot.Drawing.Colormaps
    ...
    Public Class Phase
        ...
        Public Function GetRGB(value As Byte) As Tuple(Of Byte, Byte, Byte) Implements ScottPlot.Drawing.IColormap.GetRGB
            Return New Tuple(Of Byte, Byte, Byte)(Phase.CmapLocal(value, 0), Phase.CmapLocal(value, 1), Phase.CmapLocal(value, 2))
        End Function

        Public ReadOnly Property Name As String = "Phase" Implements ScottPlot.Drawing.IColormap.Name
