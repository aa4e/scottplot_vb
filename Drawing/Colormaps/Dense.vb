Namespace ScottPlot.Drawing.Colormaps
    ...
    Public Class Dense
        ...
        Public Function GetRGB(value As Byte) As Tuple(Of Byte, Byte, Byte) Implements ScottPlot.Drawing.IColormap.GetRGB
            Return New Tuple(Of Byte, Byte, Byte)(Dense.CmapLocal(value, 0), Dense.CmapLocal(value, 1), Dense.CmapLocal(value, 2))
        End Function

        Public ReadOnly Property Name As String = "Dense" Implements ScottPlot.Drawing.IColormap.Name
