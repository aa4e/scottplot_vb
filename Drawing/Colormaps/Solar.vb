Namespace ScottPlot.Drawing.Colormaps
    ...
    Public Class Solar
        ...
        Public Function GetRGB(value As Byte) As Tuple(Of Byte, Byte, Byte) Implements ScottPlot.Drawing.IColormap.GetRGB
            Return New Tuple(Of Byte, Byte, Byte)(Solar.CmapLocal(value, 0), Solar.CmapLocal(value, 1), Solar.CmapLocal(value, 2))
        End Function

        Public ReadOnly Property Name As String = "Solar" Implements ScottPlot.Drawing.IColormap.Name
