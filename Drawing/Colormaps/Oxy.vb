Namespace ScottPlot.Drawing.Colormaps
    ...
    Public Class Oxy
        ...
        Public Function GetRGB(value As Byte) As Tuple(Of Byte, Byte, Byte) Implements ScottPlot.Drawing.IColormap.GetRGB
            Return New Tuple(Of Byte, Byte, Byte)(Oxy.CmapLocal(value, 0), Oxy.CmapLocal(value, 1), Oxy.CmapLocal(value, 2))
        End Function

        Public ReadOnly Property Name As String = "Oxy" Implements ScottPlot.Drawing.IColormap.Name
